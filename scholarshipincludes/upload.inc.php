<?php
	if(isset($_POST['submit'])){
		...
		if($FileError === 0){
			$FileDestination = "../documents/scholarships/".$FileName;
			...
			if(!mysqli_stmt_prepare($stmt,$sql)){
				...
				$sql="INSERT INTO scholarships(name,description,fileorder) VALUES(?,?,?);";
				if(!mysqli_stmt_prepare($stmt,$sql)){
				echo "sql statement failed!";
				exit();
				}
					...
					header("location:../scholarship.php?upload=success");
			}
		}
	}
		else{
